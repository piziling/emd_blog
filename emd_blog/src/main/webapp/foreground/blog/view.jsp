...
<div class="data_list">
	...
	<div>
	   ...
	   <div style="padding-left: 330px;padding-bottom: 20px;padding-top: 10px">
		...
		<div class="blog_info">
			发布时间：『 <fmt:formatDate value="${blog.releaseDate }" type="date" pattern="yyyy-MM-dd HH:mm"/>』&nbsp;&nbsp;文章类别：${blog.blogType.typeName}&nbsp;&nbsp;阅读(${blog.clickHit}) 评论(${blog.replyHit})
		</div>
